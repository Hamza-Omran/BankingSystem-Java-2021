...
This project was created during my first year in college while learning Java and desktop application development with Swing.
It is uploaded only for historical reference and does not reflect my current coding standards.
