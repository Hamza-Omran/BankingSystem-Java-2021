...
public class Deposits extends MenuBar implements ActionListener {
    ...
    Deposits() {
        ...
        p2.setBackground(new Color(161, 161, 161));
        
        p3.setBounds(20,380,410,130);
        p3.setBackground(new Color(255, 215, 0));
        
        tit=new JLabel("Welcome To Deposits Manager");
        ...
        ammount =new JLabel("Enter Deposits Ammount :");
        time=new JLabel("Enter Period For The Deposits (Months):");
        
        ammount.setBounds(200,200,630,80);
        ammount.setFont(new Font(null,Font.BOLD,35));
        
        time.setBounds(20,300,750,80);
    ...
    public void actionPerformed(ActionEvent ae) {
      super.actionPerformed(ae);
        ...
        if(x>=1000&&y>=1&&x<=IDofclient.get(w).getBalance())
        {
            ...
            IDofclient.get(w).setDeposits(x+IDofclient.get(w).getDeposits());
            IDofclient.get(w).setDeposits(y);
            IDofclient.get(w).setDeposits(x);
            JOptionPane.showMessageDialog(null,"Congrats Deposit has been added.","Error",JOptionPane.INFORMATION_MESSAGE );
        }
        else
