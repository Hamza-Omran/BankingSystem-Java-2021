...
public class Deposit extends MenuBar implements ActionListener {
    JTextField t;
    JButton ok;
    Deposit() {      
        t=new JTextField();
        ...
        JLabel dg=new JLabel("Deposit Money Manager");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        JOptionPane.showMessageDialog(null,"your money has been deposited successfully","information",JOptionPane.INFORMATION_MESSAGE );
           
        }
        else
            JOptionPane.showMessageDialog(null,"enter number more than 100","Error",JOptionPane.INFORMATION_MESSAGE );
